...
epl = [
    ...
    {'team_id': 3, 'name': '맨체스터 유나이티드 FC',
     'img_url': 'http://pngimg.com/uploads/manchester_united/manchester_united_PNG27.png', 'like': 0, 'status': '맨유',
     'league': 'EPL'},
    ...
    {'team_id': 11, 'name': '사우샘프턴 FC',
     'img_url': 'https://w.namu.la/s/6359ab6954536d8bfa7823b6a1ac75f4989d150b268e3859aee510771ef0f2979c6e645762f5ddba275eec4569cf4de426d09f342b1901a1a87c51567ccb362fa68501ffb6ac553009f2bce2c0c6c4c12e5a97a6949f60f8a813709afc6c1e37', 'like': 0,
     'status': '웨햄',
     'league': 'EPL'},
    ...
    {'team_id': 19, 'name': '번리 FC',
     ...
     'status': '웨햄',
     'league': 'EPL'},
    {'team_id': 20, 'name': '노리치 시티 FC',     'img_url': 'https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2Fco5k34%2FbtqEdkfzg7C%2Fjd05vdzW1HMdjS8GaLi5t0%2Fimg.png',
     'like': 0,     'status': '웨햄',     'league': 'EPL'}
]
laliga = [
